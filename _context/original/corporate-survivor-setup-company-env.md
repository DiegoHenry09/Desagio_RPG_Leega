...
## 2. Estrutura do repositório (esperada após Sprint 0)
...
| Rodar auditoria | `bash scripts/audit.sh` |
...
## 10. Definition of Done do Sprint 0 (validação obrigatória)

Antes de declarar Sprint 0 concluído, executar **neste exato ambiente** (ambiente da empresa):
